...
// The BLNS tests merely test that `markdownToDocument` does not throw or hang while
...
void main() {
  ...
  for (final str in blns) {
    test('blns string $index', () {
      final doc = markdownToDocument(str);
      final mds = documentToMarkdown(doc);
      expect(mds, const TypeMatcher<String>());
    });
    index++;
  }
}
